 ...
 */
@Entity
@Table(name="OtherParty")
public class OtherParty extends ObjectData{
    private final static String nameColumn1 = "Ім'я";
    private final static String nameColumn2 = "Прізвище";

    public OtherParty(String fName, String lName, String status, Long numPh, String addr) {
        this.fName = fName;
        this.lName = lName;
        this.status = status;
        this.numPh = numPh;
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "IDothp")
    Set<RepresentativesOthP> representativesOthPs = new HashSet<>();
    ...
    public Set<RepresentativesOthP> getRepresentativesOthPSet() {
        return representativesOthPs;
    }

    public void setRepresentativesOthPSet(Set<RepresentativesOthP> representativesOthPSet) {
        this.representativesOthPs = representativesOthPSet;
    }
}
